...
int main()
{
	...
	g2_CreateWin(100, 100, 800, 600, "2D Game", true, 1.60F);
...
int Render()
{
	...
	{
		int c= g2_FontDrawText(nFont3, mouseX, mouseY, mouseX+500, mouseY+ 40, 0xffffaaff , "Mouse 위치: %d %d %d ", mouseX, mouseY, mouseZ);
	}
