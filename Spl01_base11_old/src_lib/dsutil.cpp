...
// Initializes the IDirectSound object and also sets the primary buffer
...
// CSoundManager::Get3DListenerInterface()
...
// Finding the first buffer that is not playing and return a pointer to
...
// CSound::Play()
// Plays the sound using voice management flags.  Pass in DSBPLAY_LOOPING
...
// CSound::Reset()
// Reset all of the sound buffers
...
// Setups up a buffer so data can be streamed from the wave file into
...
// Handle the notification that tells us to put more wav data in the
//       circular buffer
